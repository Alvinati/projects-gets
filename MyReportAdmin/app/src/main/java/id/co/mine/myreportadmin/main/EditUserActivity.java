    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (cursor.moveToFirst()) {
            do {
                ...
                rawUser = cursor.getString(cursor.getColumnIndex("maybank"));
        ...
        switch (requestCode) {
            case SELECT_PICTURE: {
                ...
                if (grantResults.length > 0
                    ...
                    Toast.makeText(EditUserActivity.this, "Anda tidak dapat mengupload gambar",
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, uri, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                if(response.contains("berhasil")){
                    ...
                    Toast.makeText(EditUserActivity.this, "perubahan berhasil disimpan", Toast.LENGTH_SHORT).show();
