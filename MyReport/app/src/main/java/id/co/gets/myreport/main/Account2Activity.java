...
public class Account2Activity extends AppCompatActivity {
    ...
    TextInputLayout tiUsername, tiKcp, tiEmail, tiPhone, tiKci, tiFullname, tiRegion;
    TextInputEditText etUsername, etKcp, etEmail, etPhone, etKci, etFullname, etRegion;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        profile.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (ContextCompat.checkSelfPermission(Account2Activity.this,
                        Manifest.permission.READ_EXTERNAL_STORAGE)
                        != PackageManager.PERMISSION_GRANTED) {
                    ActivityCompat.requestPermissions(Account2Activity.this,
        ...
        etRegion.setInputType(InputType.TYPE_NULL);
        ...
        etKcp.setText(dataUser[3]);
        etEmail.setText(dataUser[5]);
        etPhone.setText(dataUser[6]);
        etKci.setText(dataUser[7]);
        etRegion.setText(dataUser[8]);
        ...
        edit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                etKcp.setInputType(InputType.TYPE_CLASS_TEXT);
                etEmail.setInputType(InputType.TYPE_TEXT_VARIATION_EMAIL_ADDRESS);
                etPhone.setInputType(InputType.TYPE_CLASS_PHONE);
                etKci.setInputType(InputType.TYPE_TEXT_FLAG_MULTI_LINE);
                etRegion.setInputType(InputType.TYPE_CLASS_TEXT);
        ...
        switch (requestCode) {
            case SELECT_PICTURE: {
                ...
                if (grantResults.length > 0
                   ...
                   Toast.makeText(Account2Activity.this, "Anda tidak dapat mengupload gambar",
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, uri, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                if(response.contains("berhasil")){
                    ...
                    Toast.makeText(Account2Activity.this, "perubahan berhasil disimpan", Toast.LENGTH_SHORT).show();
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                params.put("nama_vendor", etKcp.getText().toString());
                params.put("nama_lengkap", etFullname.getText().toString());
                params.put("email", etEmail.getText().toString());
                params.put("no_telp", etPhone.getText().toString());
                params.put("alamat", etKci.getText().toString());
                params.put("kota", etRegion.getText().toString());
